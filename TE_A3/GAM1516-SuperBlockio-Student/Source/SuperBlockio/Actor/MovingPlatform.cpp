...
AMovingPlatform::AMovingPlatform()
{
    ...
    Target1 = CreateDefaultSubobject<UBoxComponent>(("Target1"));
    ...
    Target2 = CreateDefaultSubobject<UBoxComponent>(("Target2"));
    ...
    BoxCollision = CreateDefaultSubobject<UBoxComponent>(("UBoxComponent"));
    ...
    PlatformSprite = CreateDefaultSubobject<UPaperSpriteComponent>(("PlatformSprite"));
...
void AMovingPlatform::Tick(float DeltaTime)
{
    ...
    float DistanceToPoint = Delta.Size(); // not sure if its a float?
