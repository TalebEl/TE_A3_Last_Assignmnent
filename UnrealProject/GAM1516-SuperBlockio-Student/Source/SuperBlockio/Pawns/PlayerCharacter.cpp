...
APlayerCharacter::APlayerCharacter()
{
    ...
    BoxComponent->SetCollisionProfileName("OverlappAll");
...
void APlayerCharacter::BeginPlay()
{
    ...
    if(FloatCurve != nullptr)
    {
        ...
        MyTimeline = NewObject<UTimelineComponent>(this, FName("Jump Gravity")); // NOT SURE
...
void APlayerCharacter::JumpReleased()
{
    ...
    if(MyTimeline != nullptr)
    {
        ...
        GetCharacterMovement()->GravityScale = EndJumpGravity; // not sure
    }
	//ENDIF
}
